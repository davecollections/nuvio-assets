...
The published people-artwork collection contains exactly 310 TMDB person identities, with one landscape and one poster WebP per person (310 landscape and 310 poster assets):
...
The complete 295-person initial actor tier is published. Later and review actor tiers remain unpublished, so the full 523-actor catalogue is not yet available. Director publication remains limited to people already present in this 310-person category-neutral set; the full 300-director catalogue is not published. Actor and director memberships reuse the same physical artwork for a shared TMDB person ID. Future people-artwork publication remains explicitly bounded; the tooling has no network, commit, or push capability.
