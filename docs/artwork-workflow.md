...
| Discover | Category manifest schemaVersion 2 now supplies 120 WebPs: the 60 original roles plus 60 approved poster/square cover/focus assets. The new shapes use 30 distinct English-original/US-origin title images. Extension installed for authorised commit/push; original files and URLs preserved. Refresh cadence is investigated, with no schedule enabled. General Builder support is not implemented. | [Discover handover](artwork-categories/discover.md) |
