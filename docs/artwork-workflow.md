...
| Decades | Category manifest schemaVersion 2 supplies 194 WebPs. The approved pearl-white release replaces 144 cover/focus images across all eight decades, three media variants and three shapes; 24 heroes, 24 title logos and two parent covers are retained. All filenames, paths and canonical URLs are preserved. Not included in runtime-lookup.json. | [Decades handover](artwork-categories/decades.md) |
...
| Genres | Category manifest schemaVersion 2 supplies 248 approved WebPs across 31 eight-role sets. Original lettering on colour cards, A focus and photographic heroes replace all 62 legacy JPGs. All eight files live together under each genre slug with explicit shape filenames; exact migration mappings cover the retired JPGs and prior WebP layout. No general Builder integration or runtime-lookup entry. | [Genres handover](artwork-categories/genre.md) |
