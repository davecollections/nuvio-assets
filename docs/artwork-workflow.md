...
| Based on | Published forty approved v3 WebPs, all live-hash verified; stronger text-outline focus, separate title logos and distinct-image heroes. Five legacy JPGs retired after backup. Category manifest: assets/collection_covers/based_on/manifest.json. SchemaVersion 2 adds forty approved 800 × 1200 poster / 800 × 800 square cover/focus files, for eighty WebPs total. Installed and validated on 2026-09-08; commit/push and live verification next. Original artwork and URLs preserved. General Builder integration absent. | [Based on handover](artwork-categories/based-on.md) |
| Holiday and seasonal | Published twenty approved WebPs across five themes, all live-hash verified; three legacy JPGs retired after backup. Category manifest: assets/collection_covers/holiday/manifest.json. SchemaVersion 2 adds twenty approved 800 × 1200 poster / 800 × 800 square cover/focus files, for forty WebPs total. Installed and validated on 2026-09-08; commit/push and live verification next. Original artwork and URLs preserved. General Builder integration absent. | [Holiday handover](artwork-categories/holiday.md) |
