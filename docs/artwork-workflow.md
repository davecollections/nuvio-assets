...
| Decades | Category manifest schemaVersion 2 supplies 194 WebPs: 98 preserved original images plus 96 approved poster/square cover/focus files. The extension is installed pending Git/live URL verification. Not included in runtime-lookup.json. | [Decades handover](artwork-categories/decades.md) |
