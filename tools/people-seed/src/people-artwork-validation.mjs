...
export async function validatePeopleArtworkConfiguration({ repoRoot, registry }) {
  ...
  if (cropOverrides.records.length !== 147 || !cropOverrides.records.every((record) => record.status === "active" && record.format === "landscape")) errors.push("landscape crop overrides must contain exactly 147 active landscape records");
